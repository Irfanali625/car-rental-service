	<?php
		...
		$vehicleoverview=$_POST['vehicaleoverview'];
	...
	<head>
	    ...
	    <link rel="shortcut icon" href="img/url.png">
	    <title>Car Rental Services | Admin Edit Vehicle Info</title>
	    <style>
	    .errorWrap {
	        padding: 10px;
	        margin: 0 0 20px 0;
						...
						{	?>
	                                        ...
	                                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-sm-10">
	                                                    <textarea class="form-control" name="vehicaleoverview" rows="6"
	                                                        required><?php echo htmlentities($result->VehiclesOverview);?></textarea>
	                                                </div>
	                                            </div>

	                                            <div class="form-group">
	                                                <label class="col-sm-2 control-label">Price Per Day(in PKR)</label>
	                                                <div class="col-sm-4">
	                                            ...
	                                            <div class="form-group">
	                                                <div class="col-sm-4">
	                                                    ...
	                                                    <a
	                                                        href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">
															<div class="edit-image"><p>Change
	                                                        Image 1</p></div></a>
	                                                </div>
	                                                <div class="col-sm-4">
	                                                    <img
	                                                        ...
	                                                        width="300" height="200" style="border:solid 1px #000">
	                                                    <a
	                                                        href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">
															<div class="edit-image"><p>Change
	                                                        Image 2</p></div></a>
	                                                </div>
	                                                <div class="col-sm-4">
	                                                    <img
	                                                        ...
	                                                        width="300" height="200" style="border:solid 1px #000">
	                                                    <a
	                                                        href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>"><div class="edit-image"><p>Change
	                                                        Image 3</p></div></a>
	                                                </div>
	                                            </div>
	                                            ...
	                                            <div class="form-group">
	                                                <div class="col-sm-4">
	                                                    <img
	                                                        ...
	                                                        width="300" height="200" style="border:solid 1px #000">
	                                                    <a
	                                                        href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>"><div class="edit-image"><p>Change
	                                                        Image 4</p></div></a>
	                                                </div>
	                                                <div class="col-sm-4">
											...
											echo htmlentities("File not available");
	                                                    ...
	                                                    <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage5);?>"
	                                                        width="300" height="200" style="border:solid 1px #000">
	                                                    <a
	                                                        href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>"><div class="edit-image"><p>Change
	                                                        Image 5</p></div></a>
	                                                    <?php } ?>
	                                                </div>
	                                                    ...
	                                                    <div class="col-sm-3">
	                                                        ...
	                                                        <div class="form-group">
	                                                            <div class="col-sm-8 col-sm-offset-2">
	                                                                ...
	                                                                <button tton class="btn btn-primary" name="submit"
