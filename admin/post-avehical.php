	...
	<head>
	    ...
	    <title>Car Rental Services | Admin Post Vehicle</title>
	    <style>
	    .errorWrap {
	        padding: 10px;
	        margin: 0 0 20px 0;
	                                    ...
	                                    <div class="panel-body">
	                                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-sm-10">
	                                                    <textarea class="form-control" name="vehicalorcview" rows="6"
	                                                        required></textarea>
	                                                </div>
	                                            </div>
	                                            ...
	                                            <div class="col-sm-3">
	                                                <div class="checkbox checkbox-inline">
	                                                    <input type="checkbox" id="airconditioner" name="airconditioner"
	                                                        value="1">
	                                                    <label for="airconditioner"> Air Conditions </label>
	                                                </div>
	                                            </div>
	                                            <div class="col-sm-3">
	                                                <div class="checkbox checkbox-inline">
