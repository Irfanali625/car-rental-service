...
<!--Bootstrap -->
    ...
    <title>Car Rental Services | My Profile</title>
 <style>
    .errorWrap {
    padding: 10px;
    margin: 0 0 20px 0;
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-sm-8">
                          <div class="profile_wrap">
                            <h5 class="uppercase">Genral Settings</h5>
                            <?php  
                          if($msg){?>
                          ...
                          <?php }?>
                            ...
                            <div class="form-group">
                              ...
                              <?php }} ?>          
                              <div class="form-group">
                                <button type="submit" name="updateprofile" class="w-full bg-indigo-800 p-3 text-white hover:bg-white hover:text-indigo-800 border-2 border-white text-2xl rounded-lg">Save Changes</button>
                              </div>
                            </form>
                          </div>
                        </div>
