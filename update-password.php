...
<link rel="stylesheet" href="assets/css/bootstrap.min.css" type="text/css">
    ...
    <link href="assets/css/font-awesome.min.css" rel="stylesheet">
     ...
     <title>Car Rental Services | Update Password</title>
                  ...
                  <div class="container">
                    <div class="user_profile_info gray-bg padding_4x4_40">
                      ...
                      <div class="dealer_info">
                        <h5 class="text-3xl font-semibold mb-4"><?php echo htmlentities($result->FullName);?></h5>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-sm-8">
                        <div class="profile_wrap">
                          <h6 class="uppercase mb-3">Update password</h6>
                        <form name="chngpwd" method="post" onSubmit="return valid();">
                            ...
                            <div class="form-group">
                              <input type="submit" value="Update" name="updatepass" id="submit" class="w-full bg-indigo-800 p-3 text-white hover:bg-white hover:text-indigo-800 border-2 border-white text-2xl rounded-lg">
                            </div>
                          </form>
                        </div>
                      </div>
